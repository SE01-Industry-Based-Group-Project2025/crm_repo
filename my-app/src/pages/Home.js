      ...
      >
        ...
        <section className="flex-grow flex flex-col justify-center items-center text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-20 fade-in-up delay-400">
            <button type="button" className="flex items-center justify-center gap-2 border-2 border-white px-6 py-3 rounded-full text-white font-semibold text-base hover:bg-white hover:text-[#0c3a5d] transition duration-300">
